          ...
          <div class="rounded overflow-hidden shadow-lg">
            <a href="#">
              <div class="relative">
                ...
                <a href="#!">
                  <div class="absolute bottom-0 left-0 bg-[#CF1164] px-4 py-2 text-white text-base font-medium hover:bg-white hover:text-[#CF1164] transition duration-500 ease-in-out">
                    Enroll
                  </div>
                </a>
                <a href="!#">
                  <div class="text-sm absolute top-0 right-0 bg-[#CF1164] px-4 text-white rounded-full h-16 w-16 flex flex-col items-center justify-center mt-3 mr-3  transition duration-500 ease-in-out">

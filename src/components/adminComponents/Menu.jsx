...
const Menu = () => {
  ...
  return (
    <ul className="space-y-2 font-medium">
      ...
      {isStudent && (
		...
		c4.573-0.598,8.318-3.891,9.529-8.335C492.859,384.365,491.276,379.634,487.628,376.807z"
              ...
              <span className="ml-3">My Selected Classes(student)</span>
            </ActiveRoute>
          </li>
          <li>
	...
	c-0.302,0.301-0.581,0.619-0.854,0.942H35V30z M159.12,280H135v-24.121l109.667-109.666l24.12,24.12L159.12,280z"
              ...
              <span className="ml-3">My Enrolled Classes(student)</span>
            </ActiveRoute>
          </li>
          <li>
            <ActiveRoute to="/admin/pay-history">
              <svg
                fill="currentColor"
                className="w-6 h-6 text-gray-500"
                version="1.1"
		...
		c0-7.152,5.232-12.657,18.71-13.755v29.719C90.856,81.439,86.999,77.305,86.999,70.153z"
              ...
              <span className="ml-3">My payment history(student)</span>
            </ActiveRoute>
          </li>
        </>
      )}
      ...
      {isInstructor && (
		...
		S198.261,152.155,194.962,152.155z"
              ...
              <span className="ml-3">Add Class(instructor)</span>
            </ActiveRoute>
          </li>
          <li>
            <ActiveRoute to="/admin/my-class">
              ...
              <span className="ml-3">My Classes(instructor)</span>
            </ActiveRoute>
          </li>
        </>
      )}
	...
	C165.572,167.599,158.865,152.113,157.286,140.165z"
              ...
              <span className="ml-3">Manage Classes(Admin)</span>
            </ActiveRoute>
          </li>
          <li>
            <ActiveRoute to="/admin/manage-users">
              ...
              <span className="ml-3">Manage Users(Admin)</span>
            </ActiveRoute>
          </li>
        </>
      )}
